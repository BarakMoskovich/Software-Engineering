...
int compareByAirportCode(const void* a1, const void* a2)
{
	const Airport* air1 = (Airport*)a1;
	const Airport* air2 = (Airport*)a2;

	return strcmp(air1->code, air2->code);
}

int compareByCode(const char* code1, const char* code2) {
