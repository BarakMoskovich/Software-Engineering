...
unsigned char* compressCountOptionAndNameLength(const Company*, int);
void deCompress(Company*, unsigned char*, int*);


#define DETAIL_PRINT
#define BYTE_SIZE_OF__COUNT_OPTION_NAME_LENGTH 2
